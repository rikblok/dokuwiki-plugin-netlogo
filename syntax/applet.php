...
//        $this->Lexer->addSpecialPattern('\{\{netlogo>[^\}]+\}\}',$mode,'plugin_netlogo_applet');	// replaced, look for {{*.nlogo}} instead of {{netlogo>*}} [Rik, 2012-10-12]
        $this->Lexer->addSpecialPattern('\{\{netlogo>[^\}]+\.nlogo(\?[^\}]+)?\s?\}\}',$mode,'plugin_netlogo_applet');	// look for {{*.nlogo}} instead of {{netlogo>*}}.  Todo: How to download file instead of running? [Rik, 2012-10-12]
